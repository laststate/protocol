...
Golden: [`../test-vectors/transports/latch-stream-basic.hex`](../test-vectors/transports/latch-stream-basic.hex)
...
Success for durable delivery: 1 or 2. Golden: [`../test-vectors/transports/lsak-ack-stored.hex`](../test-vectors/transports/lsak-ack-stored.hex)
